    ...
    <div className="homepage">
      ...
      <div className="top-banner">
        <div className="banner-row">
          <NavLink to="/JourneyLight" className="back-btn">
        ...
        <div className="nav-links2">
          ...
          <NavLink to="/JourneyHeavy" className="inactive-tab">Heavy</NavLink>
          <NavLink to="/JourneyLight" className="active-tab">Light</NavLink>
        </div>
      </div>
